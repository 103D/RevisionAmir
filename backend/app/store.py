...
class JsonStore:
    ...
    NOTE: This should NOT be used in production/serverless environments.
    For Vercel/serverless, use RedisStore instead.
    """

    def __init__(self, store_path: str | None = None) -> None:
        # JsonStore is for local development only
        configured_path = store_path or None
        if configured_path:
